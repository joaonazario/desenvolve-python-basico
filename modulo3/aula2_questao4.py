...
guerreiro = (personagem == "guerreiro" and pontos_forca >= 15 and pontos_magia <= 10)
mago = (personagem == "mago" and pontos_forca <= 10 and pontos_magia >= 15)
arqueiro = (personagem == "arqueiro" and pontos_forca >= 5 and pontos_forca <= 15 and pontos_magia >= 5 and pontos_magia <= 15)

validacao = guerreiro or mago or arqueiro
